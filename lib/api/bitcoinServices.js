...
internals.deserializePayment = function (pBuffer) {
...
exports.pay = {
  handler: function (request) {
    ...
    var deserializedPayment = internals.deserializePayment(paymentBuf);
    ...
    var dbCallback = function (result) {
      if (result) {
        console.log("found!");
        var deserializedPR = internals.deserializePaymentRequest(result);
