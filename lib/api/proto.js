...
exports.serializeOutput = function (oObject) {
  var outputProto = internals.paymentRequestSchema['payments.Output'];
  var outputSerialized = outputProto.serialize(oObject);
...
exports.serializePaymentRequest = function (prObject) {
  console.log(JSON.stringify(prObject));
